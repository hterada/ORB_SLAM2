...
void Frame::ComputeImageBounds(const cv::Mat &imLeft)
{
    if(mDistCoef.at<float>(0)!=0.0)
    {
        ...
        mnMinX = fmin(mat.at<float>(0,0),mat.at<float>(2,0));
        mnMaxX = fmax(mat.at<float>(1,0),mat.at<float>(3,0));
        mnMinY = fmin(mat.at<float>(0,1),mat.at<float>(1,1));
        mnMaxY = fmax(mat.at<float>(2,1),mat.at<float>(3,1));
